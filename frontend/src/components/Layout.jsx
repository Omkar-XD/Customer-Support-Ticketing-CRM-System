  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        ...
        const res = await axios.get(`${BASE_URL}/api/tickets/activities/recent`);
          ...
          <div className="hidden md:flex flex-1 max-w-xl gap-4">
            <div className="relative flex-1">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-white border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all placeholder-slate-400 shadow-sm"
              />
            </div>
            <div className="w-52 relative">
              ...
              <select 
                ...
                className="w-full pl-10 pr-8 py-2.5 bg-white border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-slate-700 appearance-none cursor-pointer font-medium shadow-sm"
              >
